...
def get_umsi_data():
	umsi_cache_id = "umsi_directory_data"
	umsi_base_url = "https://www.si.umich.edu/directory?field_person_firstname_value=&field_person_lastname_value=&rid=All&page="
	response_data = []
...
def get_five_tweets(any_string):
	...
	some_identifier = "twitter_{}".format(any_string)
	...
	for single_tweet in tweet_results["statuses"]:
		top_five_tweets.append(single_tweet['text'])
